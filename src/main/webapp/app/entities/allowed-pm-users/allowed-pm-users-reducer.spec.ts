...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ALLOWEDPMUSERS_LIST actions', async () => {
    ...
    it('dispatches FETCH_ALLOWEDPMUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ALLOWEDPMUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ALLOWEDPMUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ALLOWEDPMUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ALLOWEDPMUSERS actions', async () => {
      const expectedActions = [
        {
