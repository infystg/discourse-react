...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ANONYMOUSUSERS_LIST actions', async () => {
    ...
    it('dispatches FETCH_ANONYMOUSUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ANONYMOUSUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ANONYMOUSUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ANONYMOUSUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ANONYMOUSUSERS actions', async () => {
      const expectedActions = [
        {
