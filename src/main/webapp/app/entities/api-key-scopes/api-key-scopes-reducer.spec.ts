...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APIKEYSCOPES_LIST actions', async () => {
    ...
    it('dispatches FETCH_APIKEYSCOPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APIKEYSCOPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APIKEYSCOPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APIKEYSCOPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APIKEYSCOPES actions', async () => {
      const expectedActions = [
        {
