...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './api-keys.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APIKEYS_LIST actions', async () => {
    ...
    it('dispatches FETCH_APIKEYS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APIKEYS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APIKEYS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APIKEYS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APIKEYS actions', async () => {
      const expectedActions = [
        {
