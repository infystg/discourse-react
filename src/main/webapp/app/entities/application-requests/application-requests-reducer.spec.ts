...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './application-requests.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPLICATIONREQUESTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPLICATIONREQUESTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPLICATIONREQUESTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPLICATIONREQUESTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPLICATIONREQUESTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPLICATIONREQUESTS actions', async () => {
      const expectedActions = [
        {
