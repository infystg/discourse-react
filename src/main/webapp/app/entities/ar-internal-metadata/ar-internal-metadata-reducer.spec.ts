...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './ar-internal-metadata.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ARINTERNALMETADATA_LIST actions', async () => {
    ...
    it('dispatches FETCH_ARINTERNALMETADATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ARINTERNALMETADATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ARINTERNALMETADATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ARINTERNALMETADATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ARINTERNALMETADATA actions', async () => {
      const expectedActions = [
        {
