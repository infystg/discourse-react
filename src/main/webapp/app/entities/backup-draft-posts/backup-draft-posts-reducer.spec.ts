...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './backup-draft-posts.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BACKUPDRAFTPOSTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_BACKUPDRAFTPOSTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BACKUPDRAFTPOSTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BACKUPDRAFTPOSTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BACKUPDRAFTPOSTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BACKUPDRAFTPOSTS actions', async () => {
      const expectedActions = [
        {
