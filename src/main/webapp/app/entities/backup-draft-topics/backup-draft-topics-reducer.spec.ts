...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './backup-draft-topics.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BACKUPDRAFTTOPICS_LIST actions', async () => {
    ...
    it('dispatches FETCH_BACKUPDRAFTTOPICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BACKUPDRAFTTOPICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BACKUPDRAFTTOPICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BACKUPDRAFTTOPICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BACKUPDRAFTTOPICS actions', async () => {
      const expectedActions = [
        {
