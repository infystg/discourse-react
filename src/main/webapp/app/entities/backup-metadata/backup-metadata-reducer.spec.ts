...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BACKUPMETADATA_LIST actions', async () => {
    ...
    it('dispatches FETCH_BACKUPMETADATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BACKUPMETADATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BACKUPMETADATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BACKUPMETADATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BACKUPMETADATA actions', async () => {
      const expectedActions = [
        {
