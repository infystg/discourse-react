...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BADGEGROUPINGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_BADGEGROUPINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BADGEGROUPINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BADGEGROUPINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BADGEGROUPINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BADGEGROUPINGS actions', async () => {
      const expectedActions = [
        {
