...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BADGEPOSTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_BADGEPOSTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BADGEPOSTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BADGEPOSTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BADGEPOSTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BADGEPOSTS actions', async () => {
      const expectedActions = [
        {
