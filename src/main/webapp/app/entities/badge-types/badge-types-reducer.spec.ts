...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BADGETYPES_LIST actions', async () => {
    ...
    it('dispatches FETCH_BADGETYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BADGETYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BADGETYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BADGETYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BADGETYPES actions', async () => {
      const expectedActions = [
        {
