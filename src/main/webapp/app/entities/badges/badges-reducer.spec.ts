...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './badges.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BADGES_LIST actions', async () => {
    ...
    it('dispatches FETCH_BADGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BADGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BADGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BADGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BADGES actions', async () => {
      const expectedActions = [
        {
