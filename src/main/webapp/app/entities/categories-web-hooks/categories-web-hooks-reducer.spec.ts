...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './categories-web-hooks.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CATEGORIESWEBHOOKS_LIST actions', async () => {
    ...
    it('dispatches FETCH_CATEGORIESWEBHOOKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CATEGORIESWEBHOOKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CATEGORIESWEBHOOKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CATEGORIESWEBHOOKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CATEGORIESWEBHOOKS actions', async () => {
      const expectedActions = [
        {
