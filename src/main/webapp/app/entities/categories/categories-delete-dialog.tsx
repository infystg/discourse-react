...
export const CategoriesDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="discourseReactApp.categories.delete.question">Are you sure you want to delete this Categories?</ModalBody>
      <ModalFooter>
