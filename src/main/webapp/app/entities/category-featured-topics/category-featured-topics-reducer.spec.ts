...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './category-featured-topics.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CATEGORYFEATUREDTOPICS_LIST actions', async () => {
    ...
    it('dispatches FETCH_CATEGORYFEATUREDTOPICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CATEGORYFEATUREDTOPICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CATEGORYFEATUREDTOPICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CATEGORYFEATUREDTOPICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CATEGORYFEATUREDTOPICS actions', async () => {
      const expectedActions = [
        {
