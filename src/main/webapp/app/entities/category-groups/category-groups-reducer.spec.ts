...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CATEGORYGROUPS_LIST actions', async () => {
    ...
    it('dispatches FETCH_CATEGORYGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CATEGORYGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CATEGORYGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CATEGORYGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CATEGORYGROUPS actions', async () => {
      const expectedActions = [
        {
