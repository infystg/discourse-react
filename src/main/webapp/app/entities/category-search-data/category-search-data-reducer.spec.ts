...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './category-search-data.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CATEGORYSEARCHDATA_LIST actions', async () => {
    ...
    it('dispatches FETCH_CATEGORYSEARCHDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CATEGORYSEARCHDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CATEGORYSEARCHDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CATEGORYSEARCHDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CATEGORYSEARCHDATA actions', async () => {
      const expectedActions = [
        {
