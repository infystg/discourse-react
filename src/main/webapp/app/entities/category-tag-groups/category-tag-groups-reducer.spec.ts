...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './category-tag-groups.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CATEGORYTAGGROUPS_LIST actions', async () => {
    ...
    it('dispatches FETCH_CATEGORYTAGGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CATEGORYTAGGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CATEGORYTAGGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CATEGORYTAGGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CATEGORYTAGGROUPS actions', async () => {
      const expectedActions = [
        {
