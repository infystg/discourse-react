...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './category-tag-stats.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CATEGORYTAGSTATS_LIST actions', async () => {
    ...
    it('dispatches FETCH_CATEGORYTAGSTATS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CATEGORYTAGSTATS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CATEGORYTAGSTATS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CATEGORYTAGSTATS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CATEGORYTAGSTATS actions', async () => {
      const expectedActions = [
        {
