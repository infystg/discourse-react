...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CATEGORYTAGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_CATEGORYTAGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CATEGORYTAGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CATEGORYTAGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CATEGORYTAGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CATEGORYTAGS actions', async () => {
      const expectedActions = [
        {
