...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CATEGORYUSERS_LIST actions', async () => {
    ...
    it('dispatches FETCH_CATEGORYUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CATEGORYUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CATEGORYUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CATEGORYUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CATEGORYUSERS actions', async () => {
      const expectedActions = [
        {
