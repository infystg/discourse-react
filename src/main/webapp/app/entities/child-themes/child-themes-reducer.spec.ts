...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHILDTHEMES_LIST actions', async () => {
    ...
    it('dispatches FETCH_CHILDTHEMES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CHILDTHEMES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CHILDTHEMES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CHILDTHEMES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CHILDTHEMES actions', async () => {
      const expectedActions = [
        {
