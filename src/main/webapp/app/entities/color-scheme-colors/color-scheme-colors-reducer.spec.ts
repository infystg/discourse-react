...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './color-scheme-colors.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COLORSCHEMECOLORS_LIST actions', async () => {
    ...
    it('dispatches FETCH_COLORSCHEMECOLORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COLORSCHEMECOLORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COLORSCHEMECOLORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COLORSCHEMECOLORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COLORSCHEMECOLORS actions', async () => {
      const expectedActions = [
        {
