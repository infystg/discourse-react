...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COLORSCHEMES_LIST actions', async () => {
    ...
    it('dispatches FETCH_COLORSCHEMES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COLORSCHEMES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COLORSCHEMES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COLORSCHEMES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COLORSCHEMES actions', async () => {
      const expectedActions = [
        {
