...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CUSTOMEMOJIS_LIST actions', async () => {
    ...
    it('dispatches FETCH_CUSTOMEMOJIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CUSTOMEMOJIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CUSTOMEMOJIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CUSTOMEMOJIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CUSTOMEMOJIS actions', async () => {
      const expectedActions = [
        {
