...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEVELOPERS_LIST actions', async () => {
    ...
    it('dispatches FETCH_DEVELOPERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DEVELOPERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DEVELOPERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DEVELOPERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DEVELOPERS actions', async () => {
      const expectedActions = [
        {
