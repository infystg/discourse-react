...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DIRECTORYITEMS_LIST actions', async () => {
    ...
    it('dispatches FETCH_DIRECTORYITEMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DIRECTORYITEMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DIRECTORYITEMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DIRECTORYITEMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DIRECTORYITEMS actions', async () => {
      const expectedActions = [
        {
