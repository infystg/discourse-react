...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './dismissed-topic-users.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DISMISSEDTOPICUSERS_LIST actions', async () => {
    ...
    it('dispatches FETCH_DISMISSEDTOPICUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DISMISSEDTOPICUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DISMISSEDTOPICUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DISMISSEDTOPICUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DISMISSEDTOPICUSERS actions', async () => {
      const expectedActions = [
        {
