...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './do-not-disturb-timings.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DONOTDISTURBTIMINGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_DONOTDISTURBTIMINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DONOTDISTURBTIMINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DONOTDISTURBTIMINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DONOTDISTURBTIMINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DONOTDISTURBTIMINGS actions', async () => {
      const expectedActions = [
        {
