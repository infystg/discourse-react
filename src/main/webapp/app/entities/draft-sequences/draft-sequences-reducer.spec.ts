...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DRAFTSEQUENCES_LIST actions', async () => {
    ...
    it('dispatches FETCH_DRAFTSEQUENCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DRAFTSEQUENCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DRAFTSEQUENCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DRAFTSEQUENCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DRAFTSEQUENCES actions', async () => {
      const expectedActions = [
        {
