...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './drafts.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DRAFTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_DRAFTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DRAFTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DRAFTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DRAFTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DRAFTS actions', async () => {
      const expectedActions = [
        {
