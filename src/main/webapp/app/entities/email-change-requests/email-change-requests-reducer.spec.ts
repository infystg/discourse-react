...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './email-change-requests.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMAILCHANGEREQUESTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMAILCHANGEREQUESTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMAILCHANGEREQUESTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMAILCHANGEREQUESTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMAILCHANGEREQUESTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMAILCHANGEREQUESTS actions', async () => {
      const expectedActions = [
        {
