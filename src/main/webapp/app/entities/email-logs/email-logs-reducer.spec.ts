...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMAILLOGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMAILLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMAILLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMAILLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMAILLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMAILLOGS actions', async () => {
      const expectedActions = [
        {
