...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMAILTOKENS_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMAILTOKENS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMAILTOKENS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMAILTOKENS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMAILTOKENS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMAILTOKENS actions', async () => {
      const expectedActions = [
        {
