...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMBEDDABLEHOSTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMBEDDABLEHOSTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMBEDDABLEHOSTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMBEDDABLEHOSTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMBEDDABLEHOSTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMBEDDABLEHOSTS actions', async () => {
      const expectedActions = [
        {
