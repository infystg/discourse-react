...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './given-daily-likes.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GIVENDAILYLIKES_LIST actions', async () => {
    ...
    it('dispatches FETCH_GIVENDAILYLIKES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GIVENDAILYLIKES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GIVENDAILYLIKES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GIVENDAILYLIKES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GIVENDAILYLIKES actions', async () => {
      const expectedActions = [
        {
