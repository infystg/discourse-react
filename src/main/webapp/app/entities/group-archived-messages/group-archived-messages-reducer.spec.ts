...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './group-archived-messages.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GROUPARCHIVEDMESSAGES_LIST actions', async () => {
    ...
    it('dispatches FETCH_GROUPARCHIVEDMESSAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GROUPARCHIVEDMESSAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GROUPARCHIVEDMESSAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GROUPARCHIVEDMESSAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GROUPARCHIVEDMESSAGES actions', async () => {
      const expectedActions = [
        {
