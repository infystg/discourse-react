...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './group-category-notification-defaults.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GROUPCATEGORYNOTIFICATIONDEFAULTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_GROUPCATEGORYNOTIFICATIONDEFAULTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GROUPCATEGORYNOTIFICATIONDEFAULTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GROUPCATEGORYNOTIFICATIONDEFAULTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GROUPCATEGORYNOTIFICATIONDEFAULTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GROUPCATEGORYNOTIFICATIONDEFAULTS actions', async () => {
      const expectedActions = [
        {
