...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './group-custom-fields.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GROUPCUSTOMFIELDS_LIST actions', async () => {
    ...
    it('dispatches FETCH_GROUPCUSTOMFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GROUPCUSTOMFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GROUPCUSTOMFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GROUPCUSTOMFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GROUPCUSTOMFIELDS actions', async () => {
      const expectedActions = [
        {
