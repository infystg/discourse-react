...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GROUPHISTORIES_LIST actions', async () => {
    ...
    it('dispatches FETCH_GROUPHISTORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GROUPHISTORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GROUPHISTORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GROUPHISTORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GROUPHISTORIES actions', async () => {
      const expectedActions = [
        {
