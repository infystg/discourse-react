...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GROUPMENTIONS_LIST actions', async () => {
    ...
    it('dispatches FETCH_GROUPMENTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GROUPMENTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GROUPMENTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GROUPMENTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GROUPMENTIONS actions', async () => {
      const expectedActions = [
        {
