...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GROUPREQUESTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_GROUPREQUESTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GROUPREQUESTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GROUPREQUESTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GROUPREQUESTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GROUPREQUESTS actions', async () => {
      const expectedActions = [
        {
