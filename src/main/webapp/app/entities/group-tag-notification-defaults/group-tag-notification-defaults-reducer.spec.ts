...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './group-tag-notification-defaults.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GROUPTAGNOTIFICATIONDEFAULTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_GROUPTAGNOTIFICATIONDEFAULTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GROUPTAGNOTIFICATIONDEFAULTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GROUPTAGNOTIFICATIONDEFAULTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GROUPTAGNOTIFICATIONDEFAULTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GROUPTAGNOTIFICATIONDEFAULTS actions', async () => {
      const expectedActions = [
        {
