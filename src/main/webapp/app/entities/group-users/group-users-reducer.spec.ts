...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GROUPUSERS_LIST actions', async () => {
    ...
    it('dispatches FETCH_GROUPUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GROUPUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GROUPUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GROUPUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GROUPUSERS actions', async () => {
      const expectedActions = [
        {
