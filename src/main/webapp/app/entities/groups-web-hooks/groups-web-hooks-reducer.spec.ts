...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GROUPSWEBHOOKS_LIST actions', async () => {
    ...
    it('dispatches FETCH_GROUPSWEBHOOKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GROUPSWEBHOOKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GROUPSWEBHOOKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GROUPSWEBHOOKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GROUPSWEBHOOKS actions', async () => {
      const expectedActions = [
        {
