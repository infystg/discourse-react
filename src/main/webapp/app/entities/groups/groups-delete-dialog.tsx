...
export const GroupsDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="discourseReactApp.groups.delete.question">Are you sure you want to delete this Groups?</ModalBody>
      <ModalFooter>
