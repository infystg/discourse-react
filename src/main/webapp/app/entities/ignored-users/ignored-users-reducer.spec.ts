...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_IGNOREDUSERS_LIST actions', async () => {
    ...
    it('dispatches FETCH_IGNOREDUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_IGNOREDUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_IGNOREDUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_IGNOREDUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_IGNOREDUSERS actions', async () => {
      const expectedActions = [
        {
