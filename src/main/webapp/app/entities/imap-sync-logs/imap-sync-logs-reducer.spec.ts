...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_IMAPSYNCLOGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_IMAPSYNCLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_IMAPSYNCLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_IMAPSYNCLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_IMAPSYNCLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_IMAPSYNCLOGS actions', async () => {
      const expectedActions = [
        {
