...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INCOMINGDOMAINS_LIST actions', async () => {
    ...
    it('dispatches FETCH_INCOMINGDOMAINS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INCOMINGDOMAINS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INCOMINGDOMAINS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INCOMINGDOMAINS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INCOMINGDOMAINS actions', async () => {
      const expectedActions = [
        {
