...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INCOMINGEMAILS_LIST actions', async () => {
    ...
    it('dispatches FETCH_INCOMINGEMAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INCOMINGEMAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INCOMINGEMAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INCOMINGEMAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INCOMINGEMAILS actions', async () => {
      const expectedActions = [
        {
