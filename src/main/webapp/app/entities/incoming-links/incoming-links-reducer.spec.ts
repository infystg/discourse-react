...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INCOMINGLINKS_LIST actions', async () => {
    ...
    it('dispatches FETCH_INCOMINGLINKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INCOMINGLINKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INCOMINGLINKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INCOMINGLINKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INCOMINGLINKS actions', async () => {
      const expectedActions = [
        {
