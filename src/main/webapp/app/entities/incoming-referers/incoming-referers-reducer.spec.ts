...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './incoming-referers.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INCOMINGREFERERS_LIST actions', async () => {
    ...
    it('dispatches FETCH_INCOMINGREFERERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INCOMINGREFERERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INCOMINGREFERERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INCOMINGREFERERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INCOMINGREFERERS actions', async () => {
      const expectedActions = [
        {
