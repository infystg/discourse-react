...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INVITEDGROUPS_LIST actions', async () => {
    ...
    it('dispatches FETCH_INVITEDGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INVITEDGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INVITEDGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INVITEDGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INVITEDGROUPS actions', async () => {
      const expectedActions = [
        {
