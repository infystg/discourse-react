...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INVITEDUSERS_LIST actions', async () => {
    ...
    it('dispatches FETCH_INVITEDUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INVITEDUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INVITEDUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INVITEDUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INVITEDUSERS actions', async () => {
      const expectedActions = [
        {
