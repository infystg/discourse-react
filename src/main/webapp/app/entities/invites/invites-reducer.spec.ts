...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './invites.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INVITES_LIST actions', async () => {
    ...
    it('dispatches FETCH_INVITES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INVITES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INVITES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INVITES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INVITES actions', async () => {
      const expectedActions = [
        {
