...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './javascript-caches.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_JAVASCRIPTCACHES_LIST actions', async () => {
    ...
    it('dispatches FETCH_JAVASCRIPTCACHES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_JAVASCRIPTCACHES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_JAVASCRIPTCACHES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_JAVASCRIPTCACHES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_JAVASCRIPTCACHES actions', async () => {
      const expectedActions = [
        {
