...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LINKEDTOPICS_LIST actions', async () => {
    ...
    it('dispatches FETCH_LINKEDTOPICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LINKEDTOPICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LINKEDTOPICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LINKEDTOPICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LINKEDTOPICS actions', async () => {
      const expectedActions = [
        {
