...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MESSAGEBUS_LIST actions', async () => {
    ...
    it('dispatches FETCH_MESSAGEBUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MESSAGEBUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MESSAGEBUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MESSAGEBUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MESSAGEBUS actions', async () => {
      const expectedActions = [
        {
