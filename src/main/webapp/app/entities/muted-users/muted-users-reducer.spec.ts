...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MUTEDUSERS_LIST actions', async () => {
    ...
    it('dispatches FETCH_MUTEDUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MUTEDUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MUTEDUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MUTEDUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MUTEDUSERS actions', async () => {
      const expectedActions = [
        {
