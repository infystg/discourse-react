...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NOTIFICATIONS_LIST actions', async () => {
    ...
    it('dispatches FETCH_NOTIFICATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NOTIFICATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NOTIFICATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NOTIFICATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NOTIFICATIONS actions', async () => {
      const expectedActions = [
        {
