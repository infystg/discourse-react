...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './oauth-2-user-infos.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OAUTH2USERINFOS_LIST actions', async () => {
    ...
    it('dispatches FETCH_OAUTH2USERINFOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OAUTH2USERINFOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OAUTH2USERINFOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OAUTH2USERINFOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OAUTH2USERINFOS actions', async () => {
      const expectedActions = [
        {
