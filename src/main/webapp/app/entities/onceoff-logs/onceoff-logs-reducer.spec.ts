...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ONCEOFFLOGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_ONCEOFFLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ONCEOFFLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ONCEOFFLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ONCEOFFLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ONCEOFFLOGS actions', async () => {
      const expectedActions = [
        {
