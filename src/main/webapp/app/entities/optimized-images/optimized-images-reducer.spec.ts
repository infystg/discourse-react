...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OPTIMIZEDIMAGES_LIST actions', async () => {
    ...
    it('dispatches FETCH_OPTIMIZEDIMAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OPTIMIZEDIMAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OPTIMIZEDIMAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OPTIMIZEDIMAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OPTIMIZEDIMAGES actions', async () => {
      const expectedActions = [
        {
