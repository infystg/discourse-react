...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PERMALINKS_LIST actions', async () => {
    ...
    it('dispatches FETCH_PERMALINKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PERMALINKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PERMALINKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PERMALINKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PERMALINKS actions', async () => {
      const expectedActions = [
        {
