...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './plugin-store-rows.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PLUGINSTOREROWS_LIST actions', async () => {
    ...
    it('dispatches FETCH_PLUGINSTOREROWS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PLUGINSTOREROWS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PLUGINSTOREROWS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PLUGINSTOREROWS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PLUGINSTOREROWS actions', async () => {
      const expectedActions = [
        {
