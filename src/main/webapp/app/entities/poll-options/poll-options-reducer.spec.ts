...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POLLOPTIONS_LIST actions', async () => {
    ...
    it('dispatches FETCH_POLLOPTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POLLOPTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POLLOPTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POLLOPTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POLLOPTIONS actions', async () => {
      const expectedActions = [
        {
