...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POLLVOTES_LIST actions', async () => {
    ...
    it('dispatches FETCH_POLLVOTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POLLVOTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POLLVOTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POLLVOTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POLLVOTES actions', async () => {
      const expectedActions = [
        {
