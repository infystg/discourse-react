...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './polls.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POLLS_LIST actions', async () => {
    ...
    it('dispatches FETCH_POLLS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POLLS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POLLS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POLLS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POLLS actions', async () => {
      const expectedActions = [
        {
