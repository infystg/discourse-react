...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './post-action-types.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POSTACTIONTYPES_LIST actions', async () => {
    ...
    it('dispatches FETCH_POSTACTIONTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POSTACTIONTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POSTACTIONTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POSTACTIONTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POSTACTIONTYPES actions', async () => {
      const expectedActions = [
        {
