...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POSTACTIONS_LIST actions', async () => {
    ...
    it('dispatches FETCH_POSTACTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POSTACTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POSTACTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POSTACTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POSTACTIONS actions', async () => {
      const expectedActions = [
        {
