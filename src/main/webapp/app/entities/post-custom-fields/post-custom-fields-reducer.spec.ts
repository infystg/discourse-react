...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './post-custom-fields.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POSTCUSTOMFIELDS_LIST actions', async () => {
    ...
    it('dispatches FETCH_POSTCUSTOMFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POSTCUSTOMFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POSTCUSTOMFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POSTCUSTOMFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POSTCUSTOMFIELDS actions', async () => {
      const expectedActions = [
        {
