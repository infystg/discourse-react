...
export const PostDetailsDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(postDetailsEntity.id));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="discourseReactApp.postDetails.delete.question">Are you sure you want to delete this PostDetails?</ModalBody>
      <ModalFooter>
...
export default PostDetailsDeleteDialog;
