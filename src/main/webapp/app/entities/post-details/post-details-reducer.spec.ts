...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POSTDETAILS_LIST actions', async () => {
    ...
    it('dispatches FETCH_POSTDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POSTDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POSTDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POSTDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POSTDETAILS actions', async () => {
      const expectedActions = [
        {
