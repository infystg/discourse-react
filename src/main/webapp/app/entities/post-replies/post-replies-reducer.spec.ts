...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POSTREPLIES_LIST actions', async () => {
    ...
    it('dispatches FETCH_POSTREPLIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POSTREPLIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POSTREPLIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POSTREPLIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POSTREPLIES actions', async () => {
      const expectedActions = [
        {
