...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POSTREPLYKEYS_LIST actions', async () => {
    ...
    it('dispatches FETCH_POSTREPLYKEYS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POSTREPLYKEYS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POSTREPLYKEYS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POSTREPLYKEYS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POSTREPLYKEYS actions', async () => {
      const expectedActions = [
        {
