...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POSTREVISIONS_LIST actions', async () => {
    ...
    it('dispatches FETCH_POSTREVISIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POSTREVISIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POSTREVISIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POSTREVISIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POSTREVISIONS actions', async () => {
      const expectedActions = [
        {
