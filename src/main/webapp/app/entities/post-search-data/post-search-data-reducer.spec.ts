...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POSTSEARCHDATA_LIST actions', async () => {
    ...
    it('dispatches FETCH_POSTSEARCHDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POSTSEARCHDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POSTSEARCHDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POSTSEARCHDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POSTSEARCHDATA actions', async () => {
      const expectedActions = [
        {
