...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POSTSTATS_LIST actions', async () => {
    ...
    it('dispatches FETCH_POSTSTATS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POSTSTATS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POSTSTATS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POSTSTATS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POSTSTATS actions', async () => {
      const expectedActions = [
        {
