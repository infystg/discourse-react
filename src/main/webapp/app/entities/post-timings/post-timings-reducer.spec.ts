...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POSTTIMINGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_POSTTIMINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POSTTIMINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POSTTIMINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POSTTIMINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POSTTIMINGS actions', async () => {
      const expectedActions = [
        {
