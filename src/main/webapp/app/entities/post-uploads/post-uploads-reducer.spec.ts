...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POSTUPLOADS_LIST actions', async () => {
    ...
    it('dispatches FETCH_POSTUPLOADS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POSTUPLOADS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POSTUPLOADS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POSTUPLOADS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POSTUPLOADS actions', async () => {
      const expectedActions = [
        {
