...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PUBLISHEDPAGES_LIST actions', async () => {
    ...
    it('dispatches FETCH_PUBLISHEDPAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PUBLISHEDPAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PUBLISHEDPAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PUBLISHEDPAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PUBLISHEDPAGES actions', async () => {
      const expectedActions = [
        {
