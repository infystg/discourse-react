...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './push-subscriptions.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PUSHSUBSCRIPTIONS_LIST actions', async () => {
    ...
    it('dispatches FETCH_PUSHSUBSCRIPTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PUSHSUBSCRIPTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PUSHSUBSCRIPTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PUSHSUBSCRIPTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PUSHSUBSCRIPTIONS actions', async () => {
      const expectedActions = [
        {
