...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_QUOTEDPOSTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_QUOTEDPOSTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_QUOTEDPOSTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_QUOTEDPOSTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_QUOTEDPOSTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_QUOTEDPOSTS actions', async () => {
      const expectedActions = [
        {
