...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REMOTETHEMES_LIST actions', async () => {
    ...
    it('dispatches FETCH_REMOTETHEMES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REMOTETHEMES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REMOTETHEMES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REMOTETHEMES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REMOTETHEMES actions', async () => {
      const expectedActions = [
        {
