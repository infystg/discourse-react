...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './reviewable-claimed-topics.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REVIEWABLECLAIMEDTOPICS_LIST actions', async () => {
    ...
    it('dispatches FETCH_REVIEWABLECLAIMEDTOPICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REVIEWABLECLAIMEDTOPICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REVIEWABLECLAIMEDTOPICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REVIEWABLECLAIMEDTOPICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REVIEWABLECLAIMEDTOPICS actions', async () => {
      const expectedActions = [
        {
