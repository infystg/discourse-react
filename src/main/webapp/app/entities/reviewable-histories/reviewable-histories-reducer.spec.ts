...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './reviewable-histories.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REVIEWABLEHISTORIES_LIST actions', async () => {
    ...
    it('dispatches FETCH_REVIEWABLEHISTORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REVIEWABLEHISTORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REVIEWABLEHISTORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REVIEWABLEHISTORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REVIEWABLEHISTORIES actions', async () => {
      const expectedActions = [
        {
