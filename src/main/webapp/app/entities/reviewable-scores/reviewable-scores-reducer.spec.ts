...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './reviewable-scores.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REVIEWABLESCORES_LIST actions', async () => {
    ...
    it('dispatches FETCH_REVIEWABLESCORES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REVIEWABLESCORES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REVIEWABLESCORES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REVIEWABLESCORES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REVIEWABLESCORES actions', async () => {
      const expectedActions = [
        {
