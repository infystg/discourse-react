...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REVIEWABLES_LIST actions', async () => {
    ...
    it('dispatches FETCH_REVIEWABLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REVIEWABLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REVIEWABLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REVIEWABLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REVIEWABLES actions', async () => {
      const expectedActions = [
        {
