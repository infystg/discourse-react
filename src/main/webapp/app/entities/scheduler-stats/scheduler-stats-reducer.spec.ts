...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SCHEDULERSTATS_LIST actions', async () => {
    ...
    it('dispatches FETCH_SCHEDULERSTATS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SCHEDULERSTATS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SCHEDULERSTATS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SCHEDULERSTATS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SCHEDULERSTATS actions', async () => {
      const expectedActions = [
        {
