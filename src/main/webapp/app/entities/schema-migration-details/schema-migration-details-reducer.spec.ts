...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './schema-migration-details.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SCHEMAMIGRATIONDETAILS_LIST actions', async () => {
    ...
    it('dispatches FETCH_SCHEMAMIGRATIONDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SCHEMAMIGRATIONDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SCHEMAMIGRATIONDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SCHEMAMIGRATIONDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SCHEMAMIGRATIONDETAILS actions', async () => {
      const expectedActions = [
        {
