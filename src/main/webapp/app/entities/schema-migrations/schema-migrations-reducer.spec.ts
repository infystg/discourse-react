...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './schema-migrations.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SCHEMAMIGRATIONS_LIST actions', async () => {
    ...
    it('dispatches FETCH_SCHEMAMIGRATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SCHEMAMIGRATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SCHEMAMIGRATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SCHEMAMIGRATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SCHEMAMIGRATIONS actions', async () => {
      const expectedActions = [
        {
