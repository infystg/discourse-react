...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SCREENEDEMAILS_LIST actions', async () => {
    ...
    it('dispatches FETCH_SCREENEDEMAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SCREENEDEMAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SCREENEDEMAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SCREENEDEMAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SCREENEDEMAILS actions', async () => {
      const expectedActions = [
        {
