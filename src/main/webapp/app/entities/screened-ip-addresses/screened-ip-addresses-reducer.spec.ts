...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './screened-ip-addresses.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SCREENEDIPADDRESSES_LIST actions', async () => {
    ...
    it('dispatches FETCH_SCREENEDIPADDRESSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SCREENEDIPADDRESSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SCREENEDIPADDRESSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SCREENEDIPADDRESSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SCREENEDIPADDRESSES actions', async () => {
      const expectedActions = [
        {
