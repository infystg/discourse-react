...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SCREENEDURLS_LIST actions', async () => {
    ...
    it('dispatches FETCH_SCREENEDURLS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SCREENEDURLS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SCREENEDURLS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SCREENEDURLS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SCREENEDURLS actions', async () => {
      const expectedActions = [
        {
