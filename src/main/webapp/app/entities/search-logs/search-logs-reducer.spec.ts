...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SEARCHLOGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_SEARCHLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SEARCHLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SEARCHLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SEARCHLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SEARCHLOGS actions', async () => {
      const expectedActions = [
        {
