...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SHAREDDRAFTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_SHAREDDRAFTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SHAREDDRAFTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SHAREDDRAFTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SHAREDDRAFTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SHAREDDRAFTS actions', async () => {
      const expectedActions = [
        {
