...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './shelved-notifications.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SHELVEDNOTIFICATIONS_LIST actions', async () => {
    ...
    it('dispatches FETCH_SHELVEDNOTIFICATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SHELVEDNOTIFICATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SHELVEDNOTIFICATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SHELVEDNOTIFICATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SHELVEDNOTIFICATIONS actions', async () => {
      const expectedActions = [
        {
