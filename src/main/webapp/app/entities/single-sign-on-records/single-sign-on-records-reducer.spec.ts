...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './single-sign-on-records.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SINGLESIGNONRECORDS_LIST actions', async () => {
    ...
    it('dispatches FETCH_SINGLESIGNONRECORDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SINGLESIGNONRECORDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SINGLESIGNONRECORDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SINGLESIGNONRECORDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SINGLESIGNONRECORDS actions', async () => {
      const expectedActions = [
        {
