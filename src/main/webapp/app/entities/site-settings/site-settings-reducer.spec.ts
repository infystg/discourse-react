...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SITESETTINGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_SITESETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SITESETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SITESETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SITESETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SITESETTINGS actions', async () => {
      const expectedActions = [
        {
