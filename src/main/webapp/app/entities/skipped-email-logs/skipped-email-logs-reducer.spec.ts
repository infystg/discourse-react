...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './skipped-email-logs.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SKIPPEDEMAILLOGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_SKIPPEDEMAILLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SKIPPEDEMAILLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SKIPPEDEMAILLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SKIPPEDEMAILLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SKIPPEDEMAILLOGS actions', async () => {
      const expectedActions = [
        {
