...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STYLESHEETCACHE_LIST actions', async () => {
    ...
    it('dispatches FETCH_STYLESHEETCACHE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STYLESHEETCACHE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STYLESHEETCACHE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STYLESHEETCACHE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STYLESHEETCACHE actions', async () => {
      const expectedActions = [
        {
