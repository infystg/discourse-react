...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './tag-group-memberships.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TAGGROUPMEMBERSHIPS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TAGGROUPMEMBERSHIPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TAGGROUPMEMBERSHIPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TAGGROUPMEMBERSHIPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TAGGROUPMEMBERSHIPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TAGGROUPMEMBERSHIPS actions', async () => {
      const expectedActions = [
        {
