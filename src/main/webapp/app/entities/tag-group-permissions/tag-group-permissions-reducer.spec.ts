...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './tag-group-permissions.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TAGGROUPPERMISSIONS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TAGGROUPPERMISSIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TAGGROUPPERMISSIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TAGGROUPPERMISSIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TAGGROUPPERMISSIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TAGGROUPPERMISSIONS actions', async () => {
      const expectedActions = [
        {
