...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TAGGROUPS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TAGGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TAGGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TAGGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TAGGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TAGGROUPS actions', async () => {
      const expectedActions = [
        {
