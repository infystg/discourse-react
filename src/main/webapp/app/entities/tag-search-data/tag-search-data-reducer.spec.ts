...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TAGSEARCHDATA_LIST actions', async () => {
    ...
    it('dispatches FETCH_TAGSEARCHDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TAGSEARCHDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TAGSEARCHDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TAGSEARCHDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TAGSEARCHDATA actions', async () => {
      const expectedActions = [
        {
