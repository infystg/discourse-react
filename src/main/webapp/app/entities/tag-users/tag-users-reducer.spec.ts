...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './tag-users.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TAGUSERS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TAGUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TAGUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TAGUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TAGUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TAGUSERS actions', async () => {
      const expectedActions = [
        {
