...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TAGSWEBHOOKS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TAGSWEBHOOKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TAGSWEBHOOKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TAGSWEBHOOKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TAGSWEBHOOKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TAGSWEBHOOKS actions', async () => {
      const expectedActions = [
        {
