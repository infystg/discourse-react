...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_THEMEFIELDS_LIST actions', async () => {
    ...
    it('dispatches FETCH_THEMEFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_THEMEFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_THEMEFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_THEMEFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_THEMEFIELDS actions', async () => {
      const expectedActions = [
        {
