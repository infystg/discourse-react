...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './theme-modifier-sets.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_THEMEMODIFIERSETS_LIST actions', async () => {
    ...
    it('dispatches FETCH_THEMEMODIFIERSETS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_THEMEMODIFIERSETS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_THEMEMODIFIERSETS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_THEMEMODIFIERSETS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_THEMEMODIFIERSETS actions', async () => {
      const expectedActions = [
        {
