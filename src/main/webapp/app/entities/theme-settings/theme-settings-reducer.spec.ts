...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_THEMESETTINGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_THEMESETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_THEMESETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_THEMESETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_THEMESETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_THEMESETTINGS actions', async () => {
      const expectedActions = [
        {
