...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './theme-translation-overrides.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_THEMETRANSLATIONOVERRIDES_LIST actions', async () => {
    ...
    it('dispatches FETCH_THEMETRANSLATIONOVERRIDES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_THEMETRANSLATIONOVERRIDES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_THEMETRANSLATIONOVERRIDES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_THEMETRANSLATIONOVERRIDES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_THEMETRANSLATIONOVERRIDES actions', async () => {
      const expectedActions = [
        {
