...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './themes.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_THEMES_LIST actions', async () => {
    ...
    it('dispatches FETCH_THEMES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_THEMES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_THEMES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_THEMES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_THEMES actions', async () => {
      const expectedActions = [
        {
