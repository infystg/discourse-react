...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOPTOPICS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TOPTOPICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TOPTOPICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TOPTOPICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TOPTOPICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TOPTOPICS actions', async () => {
      const expectedActions = [
        {
