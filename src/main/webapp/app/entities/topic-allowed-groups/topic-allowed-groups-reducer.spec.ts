...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './topic-allowed-groups.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOPICALLOWEDGROUPS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TOPICALLOWEDGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TOPICALLOWEDGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TOPICALLOWEDGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TOPICALLOWEDGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TOPICALLOWEDGROUPS actions', async () => {
      const expectedActions = [
        {
