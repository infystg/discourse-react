...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './topic-allowed-users.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOPICALLOWEDUSERS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TOPICALLOWEDUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TOPICALLOWEDUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TOPICALLOWEDUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TOPICALLOWEDUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TOPICALLOWEDUSERS actions', async () => {
      const expectedActions = [
        {
