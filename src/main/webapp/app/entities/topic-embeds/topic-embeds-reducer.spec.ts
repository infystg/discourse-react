...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOPICEMBEDS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TOPICEMBEDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TOPICEMBEDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TOPICEMBEDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TOPICEMBEDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TOPICEMBEDS actions', async () => {
      const expectedActions = [
        {
