...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOPICGROUPS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TOPICGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TOPICGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TOPICGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TOPICGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TOPICGROUPS actions', async () => {
      const expectedActions = [
        {
