...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOPICINVITES_LIST actions', async () => {
    ...
    it('dispatches FETCH_TOPICINVITES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TOPICINVITES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TOPICINVITES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TOPICINVITES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TOPICINVITES actions', async () => {
      const expectedActions = [
        {
