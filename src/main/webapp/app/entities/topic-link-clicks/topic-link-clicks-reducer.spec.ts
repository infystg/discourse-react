...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './topic-link-clicks.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOPICLINKCLICKS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TOPICLINKCLICKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TOPICLINKCLICKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TOPICLINKCLICKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TOPICLINKCLICKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TOPICLINKCLICKS actions', async () => {
      const expectedActions = [
        {
