...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOPICLINKS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TOPICLINKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TOPICLINKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TOPICLINKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TOPICLINKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TOPICLINKS actions', async () => {
      const expectedActions = [
        {
