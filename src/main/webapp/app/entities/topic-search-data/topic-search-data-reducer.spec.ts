...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './topic-search-data.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOPICSEARCHDATA_LIST actions', async () => {
    ...
    it('dispatches FETCH_TOPICSEARCHDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TOPICSEARCHDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TOPICSEARCHDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TOPICSEARCHDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TOPICSEARCHDATA actions', async () => {
      const expectedActions = [
        {
