...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOPICTAGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TOPICTAGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TOPICTAGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TOPICTAGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TOPICTAGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TOPICTAGS actions', async () => {
      const expectedActions = [
        {
