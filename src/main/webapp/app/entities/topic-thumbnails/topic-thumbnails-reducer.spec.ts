...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOPICTHUMBNAILS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TOPICTHUMBNAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TOPICTHUMBNAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TOPICTHUMBNAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TOPICTHUMBNAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TOPICTHUMBNAILS actions', async () => {
      const expectedActions = [
        {
