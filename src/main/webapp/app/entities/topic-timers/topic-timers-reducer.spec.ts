...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOPICTIMERS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TOPICTIMERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TOPICTIMERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TOPICTIMERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TOPICTIMERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TOPICTIMERS actions', async () => {
      const expectedActions = [
        {
