...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOPICUSERS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TOPICUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TOPICUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TOPICUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TOPICUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TOPICUSERS actions', async () => {
      const expectedActions = [
        {
