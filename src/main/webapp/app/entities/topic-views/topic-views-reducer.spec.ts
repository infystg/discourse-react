...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOPICVIEWS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TOPICVIEWS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TOPICVIEWS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TOPICVIEWS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TOPICVIEWS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TOPICVIEWS actions', async () => {
      const expectedActions = [
        {
