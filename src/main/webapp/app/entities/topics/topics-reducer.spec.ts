...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './topics.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOPICS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TOPICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TOPICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TOPICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TOPICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TOPICS actions', async () => {
      const expectedActions = [
        {
