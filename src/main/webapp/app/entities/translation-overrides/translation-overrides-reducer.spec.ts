...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './translation-overrides.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRANSLATIONOVERRIDES_LIST actions', async () => {
    ...
    it('dispatches FETCH_TRANSLATIONOVERRIDES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRANSLATIONOVERRIDES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRANSLATIONOVERRIDES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRANSLATIONOVERRIDES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRANSLATIONOVERRIDES actions', async () => {
      const expectedActions = [
        {
