...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UNSUBSCRIBEKEYS_LIST actions', async () => {
    ...
    it('dispatches FETCH_UNSUBSCRIBEKEYS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_UNSUBSCRIBEKEYS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_UNSUBSCRIBEKEYS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_UNSUBSCRIBEKEYS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_UNSUBSCRIBEKEYS actions', async () => {
      const expectedActions = [
        {
