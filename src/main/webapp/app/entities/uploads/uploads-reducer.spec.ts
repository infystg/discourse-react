...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './uploads.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UPLOADS_LIST actions', async () => {
    ...
    it('dispatches FETCH_UPLOADS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_UPLOADS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_UPLOADS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_UPLOADS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_UPLOADS actions', async () => {
      const expectedActions = [
        {
