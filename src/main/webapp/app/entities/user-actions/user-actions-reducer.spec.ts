...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERACTIONS_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERACTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERACTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERACTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERACTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERACTIONS actions', async () => {
      const expectedActions = [
        {
