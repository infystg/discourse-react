...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './user-api-key-scopes.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERAPIKEYSCOPES_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERAPIKEYSCOPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERAPIKEYSCOPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERAPIKEYSCOPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERAPIKEYSCOPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERAPIKEYSCOPES actions', async () => {
      const expectedActions = [
        {
