...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERAPIKEYS_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERAPIKEYS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERAPIKEYS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERAPIKEYS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERAPIKEYS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERAPIKEYS actions', async () => {
      const expectedActions = [
        {
