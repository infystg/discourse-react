...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './user-archived-messages.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERARCHIVEDMESSAGES_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERARCHIVEDMESSAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERARCHIVEDMESSAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERARCHIVEDMESSAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERARCHIVEDMESSAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERARCHIVEDMESSAGES actions', async () => {
      const expectedActions = [
        {
