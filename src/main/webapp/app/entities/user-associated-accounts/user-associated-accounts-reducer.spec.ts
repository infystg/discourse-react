...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './user-associated-accounts.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERASSOCIATEDACCOUNTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERASSOCIATEDACCOUNTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERASSOCIATEDACCOUNTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERASSOCIATEDACCOUNTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERASSOCIATEDACCOUNTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERASSOCIATEDACCOUNTS actions', async () => {
      const expectedActions = [
        {
