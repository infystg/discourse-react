...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './user-auth-token-logs.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERAUTHTOKENLOGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERAUTHTOKENLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERAUTHTOKENLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERAUTHTOKENLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERAUTHTOKENLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERAUTHTOKENLOGS actions', async () => {
      const expectedActions = [
        {
