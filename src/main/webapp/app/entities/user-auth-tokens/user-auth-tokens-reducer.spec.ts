...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERAUTHTOKENS_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERAUTHTOKENS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERAUTHTOKENS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERAUTHTOKENS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERAUTHTOKENS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERAUTHTOKENS actions', async () => {
      const expectedActions = [
        {
