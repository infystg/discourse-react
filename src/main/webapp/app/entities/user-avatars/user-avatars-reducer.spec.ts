...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERAVATARS_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERAVATARS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERAVATARS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERAVATARS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERAVATARS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERAVATARS actions', async () => {
      const expectedActions = [
        {
