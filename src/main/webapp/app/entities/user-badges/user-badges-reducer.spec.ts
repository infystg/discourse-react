...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERBADGES_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERBADGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERBADGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERBADGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERBADGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERBADGES actions', async () => {
      const expectedActions = [
        {
