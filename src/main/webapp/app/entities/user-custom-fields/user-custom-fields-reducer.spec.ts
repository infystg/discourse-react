...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './user-custom-fields.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERCUSTOMFIELDS_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERCUSTOMFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERCUSTOMFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERCUSTOMFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERCUSTOMFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERCUSTOMFIELDS actions', async () => {
      const expectedActions = [
        {
