...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USEREMAILS_LIST actions', async () => {
    ...
    it('dispatches FETCH_USEREMAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USEREMAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USEREMAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USEREMAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USEREMAILS actions', async () => {
      const expectedActions = [
        {
