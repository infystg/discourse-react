...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USEREXPORTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_USEREXPORTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USEREXPORTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USEREXPORTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USEREXPORTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USEREXPORTS actions', async () => {
      const expectedActions = [
        {
