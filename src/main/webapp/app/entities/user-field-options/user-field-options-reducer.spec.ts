...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './user-field-options.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERFIELDOPTIONS_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERFIELDOPTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERFIELDOPTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERFIELDOPTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERFIELDOPTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERFIELDOPTIONS actions', async () => {
      const expectedActions = [
        {
