...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERFIELDS_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERFIELDS actions', async () => {
      const expectedActions = [
        {
