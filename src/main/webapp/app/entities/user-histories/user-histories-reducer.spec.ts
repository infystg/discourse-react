...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERHISTORIES_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERHISTORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERHISTORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERHISTORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERHISTORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERHISTORIES actions', async () => {
      const expectedActions = [
        {
