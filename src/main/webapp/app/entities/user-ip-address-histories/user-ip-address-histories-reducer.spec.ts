...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './user-ip-address-histories.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERIPADDRESSHISTORIES_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERIPADDRESSHISTORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERIPADDRESSHISTORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERIPADDRESSHISTORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERIPADDRESSHISTORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERIPADDRESSHISTORIES actions', async () => {
      const expectedActions = [
        {
