...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './user-notification-schedules.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERNOTIFICATIONSCHEDULES_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERNOTIFICATIONSCHEDULES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERNOTIFICATIONSCHEDULES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERNOTIFICATIONSCHEDULES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERNOTIFICATIONSCHEDULES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERNOTIFICATIONSCHEDULES actions', async () => {
      const expectedActions = [
        {
