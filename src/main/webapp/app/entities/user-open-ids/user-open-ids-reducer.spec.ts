...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USEROPENIDS_LIST actions', async () => {
    ...
    it('dispatches FETCH_USEROPENIDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USEROPENIDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USEROPENIDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USEROPENIDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USEROPENIDS actions', async () => {
      const expectedActions = [
        {
