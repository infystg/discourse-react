...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USEROPTIONS_LIST actions', async () => {
    ...
    it('dispatches FETCH_USEROPTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USEROPTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USEROPTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USEROPTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USEROPTIONS actions', async () => {
      const expectedActions = [
        {
