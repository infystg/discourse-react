...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './user-profile-views.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERPROFILEVIEWS_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERPROFILEVIEWS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERPROFILEVIEWS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERPROFILEVIEWS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERPROFILEVIEWS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERPROFILEVIEWS actions', async () => {
      const expectedActions = [
        {
