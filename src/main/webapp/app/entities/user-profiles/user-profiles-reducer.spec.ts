...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERPROFILES_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERPROFILES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERPROFILES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERPROFILES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERPROFILES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERPROFILES actions', async () => {
      const expectedActions = [
        {
