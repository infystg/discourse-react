...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERSEARCHDATA_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERSEARCHDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERSEARCHDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERSEARCHDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERSEARCHDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERSEARCHDATA actions', async () => {
      const expectedActions = [
        {
