...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './user-second-factors.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERSECONDFACTORS_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERSECONDFACTORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERSECONDFACTORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERSECONDFACTORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERSECONDFACTORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERSECONDFACTORS actions', async () => {
      const expectedActions = [
        {
