...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './user-security-keys.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERSECURITYKEYS_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERSECURITYKEYS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERSECURITYKEYS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERSECURITYKEYS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERSECURITYKEYS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERSECURITYKEYS actions', async () => {
      const expectedActions = [
        {
