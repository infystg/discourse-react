...
import { getEntity, deleteEntity } from './user-stats.reducer';

export const UserStatsDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="discourseReactApp.userStats.delete.question">Are you sure you want to delete this UserStats?</ModalBody>
      <ModalFooter>
