...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERUPLOADS_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERUPLOADS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERUPLOADS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERUPLOADS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERUPLOADS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERUPLOADS actions', async () => {
      const expectedActions = [
        {
