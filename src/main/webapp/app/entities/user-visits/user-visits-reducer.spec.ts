...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERVISITS_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERVISITS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERVISITS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERVISITS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERVISITS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERVISITS actions', async () => {
      const expectedActions = [
        {
