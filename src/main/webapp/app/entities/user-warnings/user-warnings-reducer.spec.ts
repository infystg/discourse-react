...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERWARNINGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERWARNINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERWARNINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERWARNINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERWARNINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERWARNINGS actions', async () => {
      const expectedActions = [
        {
