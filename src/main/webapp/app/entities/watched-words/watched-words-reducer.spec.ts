...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WATCHEDWORDS_LIST actions', async () => {
    ...
    it('dispatches FETCH_WATCHEDWORDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WATCHEDWORDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WATCHEDWORDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WATCHEDWORDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WATCHEDWORDS actions', async () => {
      const expectedActions = [
        {
