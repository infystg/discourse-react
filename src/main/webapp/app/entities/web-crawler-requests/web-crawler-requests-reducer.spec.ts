...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './web-crawler-requests.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WEBCRAWLERREQUESTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_WEBCRAWLERREQUESTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WEBCRAWLERREQUESTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WEBCRAWLERREQUESTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WEBCRAWLERREQUESTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WEBCRAWLERREQUESTS actions', async () => {
      const expectedActions = [
        {
