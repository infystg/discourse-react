...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './web-hook-event-types-hooks.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WEBHOOKEVENTTYPESHOOKS_LIST actions', async () => {
    ...
    it('dispatches FETCH_WEBHOOKEVENTTYPESHOOKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WEBHOOKEVENTTYPESHOOKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WEBHOOKEVENTTYPESHOOKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WEBHOOKEVENTTYPESHOOKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WEBHOOKEVENTTYPESHOOKS actions', async () => {
      const expectedActions = [
        {
