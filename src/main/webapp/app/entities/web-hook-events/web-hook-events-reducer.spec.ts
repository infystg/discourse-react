...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WEBHOOKEVENTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_WEBHOOKEVENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WEBHOOKEVENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WEBHOOKEVENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WEBHOOKEVENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WEBHOOKEVENTS actions', async () => {
      const expectedActions = [
        {
