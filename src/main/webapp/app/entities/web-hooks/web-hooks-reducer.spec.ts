...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './web-hooks.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WEBHOOKS_LIST actions', async () => {
    ...
    it('dispatches FETCH_WEBHOOKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WEBHOOKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WEBHOOKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WEBHOOKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WEBHOOKS actions', async () => {
      const expectedActions = [
        {
